...
const Strings = [
 ...
 },
 {
    ...
    // seal wizard
    sealUnset: '生成密钥以开启端到端加密话题。',
    sealUnlocked: '禁用加密密钥将导致此设备无法访问所有端到端加密话题，直到再次解锁。',
    sealLocked: '请解锁加密密钥以在此设备上查看端到端加密话题。',
    sealDelete: '删除加密密钥将永久移除你所有设备对现有加密话题的访问权限。',
    password: '密码',
    ...
    enableTopics: '启用加密话题',
    manageTopics: '管理加密密钥',
    changePassword: '修改加密密钥密码',
    update: '更改',
    changeKey: '修改密钥密码',
    delayMessage: '密钥生成可能需要几分钟时间。',
    changeMessage: '你可以在此处修改账户的用户名和/或密码。',
    ...
    close: '关闭',
    ok: '确定',
    noBlockedContacts: '暂无已屏蔽联系人',
    noBlockedTopics: '暂无已屏蔽话题',
    noBlockedMessages: '暂无已屏蔽消息',
    restore: '还原',
    ...
    enableCalls: '启用 WebRTC 通话',
    iceService: 'Cloudflare 服务',
    relayUrl: '中继 URL',
    relayUsername: '中继用户名',
    relayPassword: '中继密码',
    ...
    server: '服务器',
    access: '访问',
    defaultPublic: '默认公共服务器仅供测试。请尽量使用私有服务器。',
    confirmPassword: '确认密码',
    accountLogin: '账户登录',
    accessAccount: '进入账户',
    agree: '我同意服务条款',
