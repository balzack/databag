    ...
    <Animated.View style={{...viewStyle, opacity}}>
      {state.calling && (
        <View style={styles.call}>
          ...
          {state.localVideo && (
            <RTCView style={state.remoteVideo ? styles.box : styles.full} mirror={true} objectFit={'contain'} streamURL={state.localStream.toURL()} zOrder={state.remoteVideo && state.fullscreen ? 2 : 0} />
          )}
