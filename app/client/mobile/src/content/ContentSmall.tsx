              ...
              renderItem={({item}) => {
                ...
                const action = (
                  <Menu
                    ...
                    anchor={<IconButton style={styles.action} contentStyle={styles.actionPad} rippleColor="transparent" icon="dots-horizontal-circle-outline" size={22} onPress={() => setMore(`${item.cardId}:${item.channelId}`)} />}>
                    {Platform.OS === 'ios' && (
