...
export const it = {
  ...
  accountKeyType: 'Tipo Chiave Account',
  ...
  appPermission: 'L\'app non ha accesso ai file multimediali',
  ...
  generateKey: 'Genera una chiave per abilitare le conversazioni con crittografia end-to-end.',
  ...
  createSealed: 'Crea Argomenti E2EE',
  ...
  welcomeTo: 'Benvenuto su Databag',
  notUser: 'Non sei un utente?',
  adminAccess: 'Accesso Amministratore',
  yourProfile: 'Imposta il tuo Profilo',
  ...
  skipSetup: 'Salta',
  allDone: 'Tutto Fatto!',
  moreContacts: 'Puoi trovare altre persone nella scheda contatti. Una volta accettato, puoi iniziare una conversazione privata.',
  messaging: 'Messaggistica',
  manageSealed: 'Gestisci Argomenti Sigillati',
  format: 'Formato',
  fontFormat: 'Aa Dimensione Carattere',
  dateLabel: 'Data',
  hourLabel: 'Ora',
  blocked: 'Bloccato',
  messages: 'Messaggi',
  ...
  viewTerms: 'Visualizza Termini di Servizio',
  acceptTerms: 'Accetta Termini di Servizio',
  ...
  selectShare: 'Seleziona Argomento di Condivisione',

  membership: 'Partecipazione',
  channelGuest: 'Ospite Argomento',
  channelHost: 'Host Argomento',
  created: 'Creato',
  code: 'it',
  ...
  blockedTopics: 'Argomenti Bloccati',
  blockedMessages: 'Messaggi Bloccati',

  sealUnlock: 'Sblocca la chiave di sigillatura per accedere ai messaggi con crittografia end-to-end',
  sealForget: 'Dimentica la chiave di sigillatura per revocare l\'accesso ai messaggi crittografati solo per questo dispositivo',
  sealDelete: 'L\'eliminazione della chiave revocherà permanentemente l\'accesso a tutti i messaggi crittografati da tutti i dispositivi',
  sealUpdate: 'L\'aggiornamento della chiave cambierà solo la password di blocco',
  ...
  members: 'Membri',
  sealedTopic: 'Argomento Sigillato',
  start: 'Inizia',

  communication: 'Comunicazione per il Web Decentralizzato',
  setupProfile: 'Imposta il tuo profilo',
  ...
  sealedTopics: 'Argomenti Sigillati',
  changeLogin: 'Modifica Credenziali',
  selectImage: 'Seleziona',
  profileImage: 'Immagine del Profilo',
  profileDetails: 'Dettagli Profilo',
  enableSealed: 'Abilita Argomenti Sigillati',
  password: 'Password',
  newPassword: 'Nuova Password',
  confirmPassword: 'Conferma Password',
  deleteKey: "Inserisci 'elimina' per rimuovere la chiave",
  delete: 'elimina',
  remove: 'Elimina',
  ...
  toCreate: 'Gli account vengono creati tramite un link generato dalla dashboard di amministrazione.',
  admin: 'Amministratore',
  loginError: 'Errore di Accesso',
  loginMessage: 'Conferma il tuo nome utente e la password.',
  createError: 'Errore Creazione Account',
  createMessage: 'Verifica con il tuo amministratore.',
  adminError: 'Errore Accesso Amministratore',
  adminMessage: 'Conferma la tua password.',
  ...
  storageLimit: 'Limite Archiviazione (GB) / Account',
  storageHint: '0 per Illimitato',
  keyType: 'Tipo Chiave Account',
  accountCreation: 'Creazione Account Pubblico',
  enablePush: 'Abilita Notifiche Push',
  allowUnsealed: 'Consenti Argomenti Non Sigillati',
  topicContent: 'Contenuto Argomento:',
  enableImage: 'Abilita Coda Immagini',
  imageHint: 'Consenti la pubblicazione di immagini negli argomenti',
  enableAudio: 'Abilita Coda Audio',
  audioHint: 'Consenti la pubblicazione di audio negli argomenti',
  enableVideo: 'Abilita Coda Video',
  videoHint: 'Consenti la pubblicazione di video negli argomenti',
  enableBinary: 'Abilita File Binari',
  binaryHint: 'Consenti la pubblicazione di file binari negli argomenti',
  enableWeb: 'Abilita Chiamate WebRTC',
  webHint: 'Abilita chiamate audio e video ai contatti',
  enableService: 'Servizio Cloudflare',
  serviceHint: 'Abilita Servizio Cloudflare',
  ...
  close: 'Chiudi',
  leave: 'Abbandona',
  confirmTopic: 'Eliminazione Argomento',
  sureTopic: 'Sei sicuro di voler eliminare questo argomento?',
  confirmLeave: 'Abbandono Argomento',
  sureLeave: 'Sei sicuro di voler abbandonare questo argomento?',
  ...
  leaveTopic: 'Abbandona Argomento',
  ...
  blockTopic: 'Blocco Argomento',
  blockTopicPrompt: 'Sei sicuro di voler bloccare l\'argomento?',
  reportTopic: 'Segnala Argomento',
  reportTopicPrompt: 'Sei sicuro di voler segnalare l\'argomento per la revisione da parte dell\'amministratore?',

  ignoring: 'Ignorando il Contatto',
  connfirmIgnoring: 'Sei sicuro di voler ignorare la richiesta?',
  denying: 'Rifiutando il Contatto',
  ...
  mfaError: 'errore del codice di verifica',
  mfaDisabled: 'verifica temporaneamente disabilitata',
  mfaConfirm: 'Conferma',
  mfaEnter: 'Inserisci il tuo codice di verifica',

  enableMultifactor: 'Abilita l\'autenticazione a più fattori',
  disableMultifactor: 'Disabilita l\'autenticazione a più fattori',

  disable: 'Disabilita',
  confirmDisable: 'Disabilitazione Autenticazione a Più Fattori',
  disablePrompt: 'Sei sicuro di voler disabilitare l\'autenticazione a più fattori?',
};