...
If you choose to setup your server manually, you can follow the steps in the Dockerfile [here](/net/container/Dockerfile) or Raspberry Pi Zero instructions [here](/doc/pizero.md)
