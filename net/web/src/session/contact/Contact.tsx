  ...
  return (
    <ContactWrapper>
      ...
      <div className={state.display === 'small' || state.display === 'xlarge' ? 'frame' : 'drawer'}>
        ...
        {state.display !== 'xlarge' && state.display !== 'small' && <div className="top">{state.handle}</div>}
        ...
        <div className={state.display === 'xlarge' ? 'midContent' : 'rightContent'}>
          ...
          <div className="details">
            <div className="name">
              {state.name && <div className="data">{state.name}</div>}
              {!state.name && <div className="data notset">{state.strings.name}</div>}
            </div>
            {state.node && (
            ...
            <div className="location">
              <EnvironmentOutlined />
              {state.location && <div className="data">{state.location}</div>}
              {!state.location && <div className="data notset">{state.strings.location}</div>}
            </div>
            <div className="description">
              <BookOutlined />
              {state.description && <div className="data">{state.description}</div>}
              {!state.description && <div className="data notset">{state.strings.description}</div>}
            </div>
          </div>
        </div>
        ...
        <div className="actions">
          ...
          <div className="controls">
            {state.status === 'connected' && (
              ...
              >
                <Button
                  ...
                  icon={<UserDeleteOutlined />}
                  size="medium"
                  onClick={() => disconnect(actions.disconnect)}
                >
            ...
            {state.status === 'connected' && (
              ...
              >
                <Button
                  ...
                  icon={<DeleteOutlined />}
                  size="medium"
                  onClick={() => remove(actions.disconnectRemove)}
                >
            ...
            {state.status === 'pending' && (
              <Tooltip
                placement="top"
                title={state.strings.saveContact}
              >
                <Button
                  className="button"
                  type="primary"
                  ...
                  size="medium"
                  onClick={() => updateContact(actions.confirmContact)}
                >
                  {state.strings.save}
                </Button>
              </Tooltip>
            ...
            {state.status === 'pending' && (
              <Tooltip
                placement="top"
                title={state.strings.saveAccept}
              >
                <Button
                  className="button"
                  type="primary"
                  ...
                  size="medium"
                  onClick={() => updateContact(actions.connect)}
                >
            ...
            {state.status === 'pending' && (
              <Tooltip
                placement="top"
                title={state.strings.ignoreRequest}
              >
                <Button
                  className="button"
                  type="primary"
            ...
            {state.status === 'requested' && (
              <Tooltip
                placement="top"
                title={state.strings.acceptConnection}
              >
                <Button
                  className="button"
                  type="primary"
                  ...
                  icon={<UserSwitchOutlined />}
                  size="medium"
                  onClick={() => updateContact(actions.saveConnect)}
                >
                  {state.strings.cancel}
                </Button>
              </Tooltip>
            ...
            {state.status === 'connecting' && (
              <Tooltip
                placement="top"
                title={state.strings.cancelRequest}
              >
                <Button
                  className="button"
                  type="primary"
            ...
            {state.status === 'confirmed' && (
              <Tooltip
                placement="top"
                title={state.strings.requestConnection}
              >
                <Button
                  className="button"
                  type="primary"
            ...
            {state.status === 'unsaved' && (
              ...
              >
                <Button
                  ...
                  icon={<UserAddOutlined />}
                  size="medium"
                  onClick={() => updateContact(actions.saveContact)}
                >
                  {state.strings.save}
                </Button>
              </Tooltip>
            ...
            {state.status === 'unsaved' && (
              <Tooltip
                placement="top"
                title={state.strings.saveRequest}
              >
                <Button
                  className="button"
                  type="primary"
            ...
            {state.offsync && (
              <Tooltip
                placement="top"
                title={state.strings.resyncContact}
              >
                <Button
                  className="button"
                  type="primary"
                  ...
                  icon={<SyncOutlined />}
                  size="medium"
                  onClick={() => updateContact(actions.resync)}
                >
