    ...
    <ProfileWrapper>
      ...
      <div className={state.display === 'xlarge' ? 'midContent' : 'rightContent'}>
        {state.urlSet && (
          <div
            className="logo"
            onClick={actions.setEditProfileImage}
          >
            <Logo
              url={state.url}
              width={'100%'}
        ...
        <div className="details">
          <div
            className="name"
            onClick={actions.setEditProfileDetails}
          >
      ...
      <Modal
        centered
        closable={false}
        visible={state.editProfileImage}
        footer={null}
        bodyStyle={{ borderRadius: 8, padding: 16, ...state.menuStyle }}
      ...
      >
        <ProfileImageWrapper>
          ...
          <div className="controls">
            ...
            <Button
              key="back"
              onClick={actions.clearEditProfileImage}
            >
      ...
      <Modal
        centered
        closable={false}
        visible={state.editProfileDetails}
        footer={null}
        bodyStyle={{ borderRadius: 8, padding: 16, ...state.menuStyle }}
        ...
        <ProfileDetailsWrapper>
          ...
          <div className="info">
            <Input
              ...
              defaultValue={state.editLocation}
              autoCapitalize="word"
            />
          </div>
          <div className="info">
          ...
          <div className="controls">
            <Button
              key="back"
              onClick={actions.clearEditProfileDetails}
            >
              {state.strings.cancel}
            </Button>
            <Button
